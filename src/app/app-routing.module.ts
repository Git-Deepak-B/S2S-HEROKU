...
const routes: Routes = [
  ...
  {path: 'provision/:id', component: ProvisionDetailComponent, canDeactivate: [CanDeactivateGuardService] },
  {path: 'customers', component: CustomerListComponent},
  {path: 'user/create', component: CreateUserComponent, canDeactivate: [CanDeactivateGuardService]},
